...
%% article title
\title{Example of using \emph{JZUS-A} \LaTeX{} template \\ second line if necessary}

%% when all authors provide emails, no $\dagger$
\author[$\dagger$$\ddagger$1]{Xin-xin ZHANG}%
...
\shortauthor{Zhang and Hu}	% one author: only Zhai; two authors: Zhai and Hu; three authors: Zhai et al.
...
\doi{10.1631/jzus.A1000000}	% DOI of the paper, should be accurate
\code{A}
\clc{TU}
...
\orcid{Xin-xin ZHANG, http://orcid.org/xxxx-xxxx-xxxx-xxxx}	% corresponding author, or first author
\articleType{}
